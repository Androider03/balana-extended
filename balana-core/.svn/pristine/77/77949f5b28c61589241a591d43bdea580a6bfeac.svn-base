...
public class AttributeDesignator extends AbstractDesignator {
	...
	public boolean equals(Object obj) {
		...
		return type.equals(other.getType()) && id.equals(other.getId()) 
				//&& issuer.equals(other.getIssuer()) 
				//&& mustBePresent == other.mustBePresent()
				&& category.equals(other.getCategory());
	}

	@Override
	public String toString() {
		return "AttributeDesignator [type=" + type + ", id=" + id + ", issuer=" + issuer + ", mustBePresent="
				+ mustBePresent + ", category=" + category + "]";
	}
