...
public abstract class AbstractAttributeSelector implements Evaluatable {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;*/
		AbstractAttributeSelector other;
		if (obj instanceof AbstractAttributeSelector)
			other = (AbstractAttributeSelector) obj;
		else return false;
	...
	public String toString() {
		return "AbstractAttributeSelector [type=" + type + ", mustBePresent=" + mustBePresent + "]";
	}
}
