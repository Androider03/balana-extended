 ...
 * Adapts a JTable's columns width to the largest content in each one.
 */
public class ColumnsAutoSizer {
	...
	public static void sizeColumnsToFit(JTable table, int columnMargin) {
		...
		if(tableHeader == null)
			return; // can't auto size a table without a header
	...
	public static void adjustFirstColumn(JTable table) {
		adjustFirstColumn(table, 5);
	}
	
	public static void adjustFirstColumn(JTable table, int columnMargin) {
		JTableHeader tableHeader = table.getTableHeader();
